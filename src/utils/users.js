...
const addUser = ({ id, username, room }) => { // Add user
  // Clean data
...
addUser({
    id: 777,
    username: 'Andrew',
    room: 'Cosmopolitan Deluxe Suite'
})
console.log(users)
const removedUser = removeUser(777)
